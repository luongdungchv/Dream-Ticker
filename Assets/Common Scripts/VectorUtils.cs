...
public static class VectorUtils
{
    ...
    public static Vector2 XZ(this Vector3 input) => new Vector2(input.x, input.z);
    public static Vector2 XY(this Vector3 input) => new Vector2(input.x, input.y);
    public static Vector2 YZ(this Vector3 input) => new Vector2(input.y, input.z);
    public static Vector2 ZX(this Vector3 input) => new Vector2(input.z, input.x);
    public static Vector2 ZY(this Vector3 input) => new Vector2(input.z, input.y);
    public static Vector2 YX(this Vector3 input) => new Vector2(input.y, input.x);
}
